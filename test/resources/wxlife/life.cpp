  ...
  m_navigator(NULL)
{
    ...
    tbBitmaps[0] = wxBitmap(reset_xpm, wxBITMAP_TYPE_XPM);
    tbBitmaps[1] = wxBitmap(open_xpm, wxBITMAP_TYPE_XPM);
    tbBitmaps[2] = wxBitmap(zoomin_xpm, wxBITMAP_TYPE_XPM);
    tbBitmaps[3] = wxBitmap(zoomout_xpm, wxBITMAP_TYPE_XPM);
    tbBitmaps[4] = wxBitmap(info_xpm, wxBITMAP_TYPE_XPM);
    tbBitmaps[5] = wxBitmap(play_xpm, wxBITMAP_TYPE_XPM);
    tbBitmaps[6] = wxBitmap(stop_xpm, wxBITMAP_TYPE_XPM);
                           ...
                           wxCAPTION | wxSIMPLE_BORDER)
{
    ...
    wxBitmap
        bmpn = wxBitmap(north_xpm, wxBITMAP_TYPE_XPM),
        bmpw = wxBitmap(west_xpm, wxBITMAP_TYPE_XPM),
        bmpc = wxBitmap(center_xpm, wxBITMAP_TYPE_XPM),
        bmpe = wxBitmap(east_xpm, wxBITMAP_TYPE_XPM),
        bmps = wxBitmap(south_xpm, wxBITMAP_TYPE_XPM);
